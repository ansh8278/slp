  ...
  members: [
    {
      id: "member-grace",
      name: "Grace",
      role: "Executive Host & Security Strategist",
      photo: "/brand/grace.webp",
      bio: "Specializes in enterprise risk management, executive leadership, and physical-cyber security convergence.",
      tag: "Host",
    ...
    },
    {
      id: "member-katie",
      name: "Katie",
      role: "Co-Host & Threat Intelligence Analyst",
      photo: "/brand/katie.webp",
      bio: "Expert in threat research, cloud resilience, and emerging AI defense strategies across digital ecosystems.",
      tag: "Co-Host",
      objectPosition: "50% 15%",
      zoom: 100,
    },
    {
      id: "member-ken",
      name: "Ken",
      role: "Senior Technical Host & Systems Architect",
      photo: "/brand/ken.webp",
      bio: "Brings over two decades of experience in electronic security systems, infrastructure protection, and hardware integrations.",
      tag: "Host",
      objectPosition: "50% 15%",
      zoom: 100,
    },
    {
      ...
      photo: "/brand/oz.webp",
      bio: "Leads podcast production, executive guest curation, and media operations for the Security Leader Podcast network.",
      tag: "Producer",
      objectPosition: "50% 15%",
      zoom: 100,
    },
